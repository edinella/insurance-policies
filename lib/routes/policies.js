...
const ensureAdmin = checkRoles(['admin']);

// list policies
router.get('/', auth, ensureAdmin, async (req, res, next) => {
...
// get policy by id
router.get('/:id', auth, ensureAdmin, async (req, res, next) => {
...
router.get('/:id/client', auth, ensureAdmin, async (req, res, next) => {
